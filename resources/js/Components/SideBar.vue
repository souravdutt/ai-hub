...
<template>
    ...
    >
        <button
            @click="toggleSidebar"
            :class="{ 'start-64 -ms-3': !sidebarVisible, 'start-0 ms-0': sidebarVisible }"
            class="fixed top-1/2 z-10 h-12 rounded px-1 opacity-80 hover:opacity-100 transition-all duration-300 bg-black text-white dark:bg-white dark:text-black"
